...
Write-Host -ForegroundColor DarkRed "  GGG   X   X  U   U  FFFFF  FFFFF  Y   Y "
Write-Host -ForegroundColor DarkRed " G        X X   U   U  F      F       Y Y  "
Write-Host -ForegroundColor DarkRed " G  GG    X    U   U  FFFF   FFFF     Y   "
Write-Host -ForegroundColor DarkRed " G   G   X X   U   U  F      F       Y Y  "
Write-Host -ForegroundColor DarkRed "  GGG   X   X   UUU   F      F        Y   "
Write-Host
Write-Host -ForegroundColor Red "BAM By Gxuffy"
